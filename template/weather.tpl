...
<section class="container">
    <div class="row">
        <div class="col-sm-22 col-sm-offset-1 col-xs-36">
            ...
            {*continents & countries & towns will be received from server*}
            <div class="row" id="weathertable">
                {*the weather of selected town will be received from server*}
            </div>
        </div>
...
<script type="text/javascript" src="/js/jsWeather.js"></script>
